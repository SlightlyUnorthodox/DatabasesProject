...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='user_id',
            field=models.AutoField(serialize=False, primary_key=True, validators=[django.core.validators.MinLengthValidator(8, b'You username must contain at least 8 characters.')]),
        ),
        migrations.AlterField(
            model_name='user',
            name='user_name',
